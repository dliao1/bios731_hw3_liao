...
the MCSE for gamma errors, which makes sense when considering that the gamma distribution takes on 
only positive values, and that the variance of a gamma distribution with 
shape = 1 and rate = 2 is a lot smaller than the variance of 2 that we used for 
the normal distribution. 

For coverages, Wald confidence intervals tended to have higher coverage for both
true betas of 0 and 0.5 across both gamma and normal errors.
